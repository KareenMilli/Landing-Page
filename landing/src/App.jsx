    ...
    <Router>
      <div>
        ...
        <div class="separator">
          ...
          <p className='animated-text'>Mombo is an HTML5 template based on Sass and Bootstrap 5 with the modern and creative multipurpose design you can use it as a startup.</p>
        </div>
        {/* Footer section */}
